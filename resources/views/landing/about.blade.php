<section class="section-about">
    <div class="page-container about-grid grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div class="about-media">
            <div class="about-image-card">
                <img src="{{ asset('img/landingpage/Mask Group.png') }}" alt="Siswa belajar" />
                <div class="about-image-arrow">
                    <svg viewBox="0 0 100 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 10 C28 18, 45 20, 60 28 C74 36, 78 46, 84 54" stroke="#8B5CF6" stroke-width="6" stroke-linecap="round" />
                        <path d="M82 54 L95 45 L91 59" stroke="#8B5CF6" stroke-width="6" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
        ...
        <div class="about-copy">
            ...
            <ul class="about-list">
                <li>
                    ...
                    Karir teknologi yang sesuai
                </li>
                <li>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                        <polyline points="9 18 15 12 9 6" />
                    </svg>
                    Potensi dan skill yang dimiliki
                </li>
                <li>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                        <polyline points="9 18 15 12 9 6" />
                    </svg>
                    Jalur belajar terbaik untuk masa depan
                </li>
            </ul>
